...
export default async function Navigation({ sticky = true, siteName = 'Reach Them' }: { sticky?: boolean, siteName?: string }) {
  // Force hardcoded site name, ignore any passed value
  const forcedSiteName = 'Reach Them';

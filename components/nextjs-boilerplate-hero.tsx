...
export function NextJSBoilerplateHero() {
  return (
    <section className="relative py-24 overflow-hidden bg-[radial-gradient(ellipse_at_top_left,rgba(56,114,187,0.10),transparent_40%),radial-gradient(ellipse_at_bottom_right,rgba(56,114,187,0.08),transparent_45%)]">
      {/* Background Pattern */}

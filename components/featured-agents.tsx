...
import { Bot, Brain, ArrowRight, Zap, Code, MessageSquare, PenTool, TrendingUp, Heart } from 'lucide-react'
...
function renderAgentIcon(icon: any) {
  ...
  if (icon === 'PenTool') return <PenTool className="w-8 h-8" />;
  if (icon === 'TrendingUp') return <TrendingUp className="w-8 h-8" />;
  if (icon === 'Heart') return <Heart className="w-8 h-8" />;
  // Emoji or fallback

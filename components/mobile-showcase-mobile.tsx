...
export function MobileShowcaseMobile() {
  return (
          ...
          >
            <div>
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Built with React Native and Expo for seamless iOS and Android deployment. 
                Your app becomes a native mobile experience with full access to device features.
              </p>
            </div>
            ...
            <div className="bg-muted/50 rounded-lg p-6">
              ...
              <p className="text-sm text-muted-foreground">
                One codebase deploys to iOS App Store and Google Play Store. 
                Maintain feature parity across all platforms with Expo development platform.
              </p>
            </div>
          </motion.div>
                  ...
                  <div className="h-full bg-gradient-to-br from-background to-muted/30 p-6 flex flex-col">
                    <div className="flex items-center justify-between mb-8">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="font-semibold text-sm">React Expo App</span>
                      </div>
